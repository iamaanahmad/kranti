    ...
    <footer className="border-t border-slate-900/5 bg-white/60 px-6 py-10 dark:bg-slate-900/60 dark:border-white/5">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 mb-10">
          ...
          {/* Platform */}
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">Platform</p>
            <nav className="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400">
              <Link href="/issues" className="hover:text-slate-900 dark:hover:text-white">Browse Issues</Link>
              <Link href="/petitions" className="hover:text-slate-900 dark:hover:text-white">Petitions</Link>
              <Link href="/campaigns" className="hover:text-slate-900 dark:hover:text-white">Campaigns</Link>
              <Link href="/create" className="hover:text-slate-900 dark:hover:text-white">Create Content</Link>
              <Link href="/guides" className="hover:text-slate-900 dark:hover:text-white">Citizen Guides</Link>
              <Link href="/transparency" className="hover:text-slate-900 dark:hover:text-white">Transparency</Link>
            </nav>
          </div>

          {/* Legal */}
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">Legal</p>
            <nav className="flex flex-col gap-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link href="/moderation" className="hover:text-slate-900 dark:hover:text-white">Moderation Policy</Link>
              <Link href="/guidelines" className="hover:text-slate-900 dark:hover:text-white">Community Guidelines</Link>
              <Link href="/about" className="hover:text-slate-900 dark:hover:text-white">About Kranti</Link>
            </nav>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href="mailto:grievance@kranti.org.in"
        ...
        <div className="border-t border-slate-900/5 pt-6 dark:border-white/5">
          <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:justify-between sm:text-left">
            <p className="text-xs text-slate-500 dark:text-slate-400">
              © {new Date().getFullYear()} Kranti — People first civic action. Licensed under AGPLv3.
            </p>
